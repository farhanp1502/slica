...
export class Chart4Component implements OnInit, AfterViewInit {
  chart: any;
  ...
  ngOnInit(): void {
    ...
    const data = {
      ...
      datasets: [{
        ...
        borderColor: '#E8F6E9', // Set line color to red
        backgroundColor: '#E8F6E9', // Set fill color to light red with opacity
        tension: 0.5,
